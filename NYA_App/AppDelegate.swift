...
class AppDelegate: UIResponder, UIApplicationDelegate,MessagingDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        GMSServices.provideAPIKey("AIzaSyB73WN2yHi3pGPCuonei0mcvGMLOs_XlJ4")
        GMSPlacesClient.provideAPIKey("AIzaSyB73WN2yHi3pGPCuonei0mcvGMLOs_XlJ4")
         LyftConfiguration.developer = (token: "moogXHbTGoBMiRGYy7UYPAqOYYp94Onjk50ZdXRe", clientId: "2")
