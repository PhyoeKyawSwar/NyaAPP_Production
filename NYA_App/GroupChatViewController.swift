...
//  NYA_App
//
//  Created by Phyo Kyaw Swar on 23/1/18.
...
class GroupChatViewController: JSQMessagesViewController {
    ...
    var messageVC = JSQMessagesViewController()
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        let query = Firebase_Constant.refs.databasegroup.queryLimited(toLast: 100)
    ...
    @IBAction func onClickTopView(_ sender: Any) {
    }
    ...
    override func didPressSend(_ button: UIButton!, withMessageText text: String!, senderId: String!, senderDisplayName: String!, date: Date!)
    {
        ...
        /* if receiveConversationPath != ""
         ...
         {*/
        let ref_obj = Firebase_Constant.refs.databasegroup.child("2345")
        // let ref_child = ref_obj.childByAutoId()
